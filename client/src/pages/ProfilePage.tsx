...
const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="App flex flex-row h-screen">
      <Navigation />
      <div className="home-screen-container flex flex-col w-full h-full overflow-y-scroll p-10 bg-gray-100 text-white ">
        <div className="bg-gray-200 p-10 rounded-xl">
          <h1 className="text-3xl mb-5">Profile Page</h1>
          <img src={background} className="h-64 w-64"></img>
